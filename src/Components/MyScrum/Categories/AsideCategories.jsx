...
function AsideCategories() {
    ...
    const handleCategoryEdition = async () => {
        ...
        const editCategory = `http://localhost:8080/backend_proj4_war_exploded/rest/users/editCategory/${selectedCategory}`;
        try {
    ...
    const deleteCategory = async () => {
        ...
        const deleteCategoryUrl = `http://localhost:8080/backend_proj4_war_exploded/rest/users/deleteCategory/${category.name}`;
